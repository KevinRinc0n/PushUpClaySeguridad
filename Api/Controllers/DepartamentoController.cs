...
public class DepartamentoController : BaseApiController
{
    ...
    public async Task<ActionResult<Pager<Departamento>>> Get([FromQuery]Params DepartamentoParams)
    {
        ...
        var listaDepartamento = mapper.Map<List<Departamento>>(departamento.registros);
        return new Pager<Departamento>(listaDepartamento, departamento.totalRegistros,DepartamentoParams.PageIndex,DepartamentoParams.PageSize,DepartamentoParams.Search);
    }
